...
kubectl --context ${CONTEXT} create -f https://raw.githubusercontent.com/ably77/solo-testbed-apps/main/argo-apps/instances/platform/gloo-edge/helm-deploy/gloo-edge-oss-helm.yaml

### check gloo-edge-oss deployment status
